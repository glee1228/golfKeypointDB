...
class Base(torch.utils.data.dataset.Dataset):
    ...
    OPTIONS = ['voc2007', 'coco2017', 'voc2007-cat-dog', 'coco2017-person', 'coco2017-car', 'coco2017-animal','obstacle','obstacleV2']
    ...
    def from_name(name: str) -> Type['Base']:
        if name == 'voc2007':
            ...
            return Obstacle
        elif name =='obstacleV2':
            from dataset.obstacleV2 import ObstacleV2
            return ObstacleV2
        else:
            raise ValueError
    ...
    def preprocess(image: PIL.Image.Image, image_min_side: float, image_max_side: float) -> Tuple[Tensor, float]:
        ...
        scale_for_longer_side = (
                    image_max_side / longer_side_after_scaling) if longer_side_after_scaling > image_max_side else 1
