    ...
    def main():
        ...
        for sub_dir in input_sub_dirnames:
            ...
            for filename in filenames:
                ...
                path_to_output_json = image_path(output_sub_dirpath,filename,'.json')
                # path_to_output_image = '/faster-RCNN/frames_output/1_360p/1_360p_0001.jpg'
                module_name = 'faster_rcnn'+'_'+backbone_name
                result = {}
                result['image_path']=path_to_input_image
                result['modules']=module_name
                result['results']=[]
                os.makedirs(os.path.join(os.path.curdir, os.path.dirname(path_to_output_json)), exist_ok=True)
                ...
                with torch.no_grad():
                    ...
                    with open(path_to_output_json, "w",encoding='utf-8') as json_file:
                        json.dump(result, json_file,ensure_ascii=False,indent=4,sort_keys=True)

                    print(f'Output json is saved to {path_to_output_json}')
    main()
