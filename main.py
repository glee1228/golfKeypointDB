...
from Training import GOLFTrain
...
def main(exp_name,
         ...
         coco_root_path="./datasets/golfDB_18pts_200",
         coco_bbox_path=None,
         seed=1,
         device=None):
    ...
    # def __init__(self,
    #              root_path="/home/mmlab/CCTV_Server/datasets/golfDB_18pts_200", data_version="train", is_train=True,
    #              use_gt_bboxes=True, bbox_path="",
